...
class BulaAISimplifierService {
  ...
  static Future<String> simplificarTextoDaBula(String textoDaBula) async {
    ...
    static Future<String> buscarInfoRemedio(String textoExtraido) async {
    print("-> Enviando texto para a IA para simplificação...");
    ...
    const prompt = """
      Você é um assistente de saúde amigável e seu objetivo é ajudar pacientes a entenderem bulas de remédio.
      Analise o texto extraido da caixa de um rémedio, contendo informações simples, como nome, quantidade e outras informações que foram extraidas
      e com base nessas informações identifique o remedio em questão consultando informações sobre o mesmo e gere um resumo claro, com linguagem popular e direta.
      Use uma linguagem que uma pessoa sem conhecimento médico possa entender facilmente.
